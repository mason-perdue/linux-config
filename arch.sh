...
timedatectl status
pacman -S vim stow sudo mesa vulkan-dzn vulkan-icd-loader usbutils sudo rsync reflector git htop man-pages man-db tree texlive openssh sane imagemagick perl-image-exiftool usbutils jdk-openjdk # helix ruff bash-language-server texlab evince
